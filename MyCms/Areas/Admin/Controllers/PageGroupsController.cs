...
namespace MyCms.Areas.Admin.Controllers
{
    ...
    public class PageGroupsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pageGroup =_pageGroupRepository.GetPageGroupId(id.Value);
            if (pageGroup == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("GroupID,GroupTitle,RecordDate,MotificationDate")] PageGroup pageGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GroupID,GroupTitle,RecordDate,MotificationDate")] PageGroup pageGroup)
        {
