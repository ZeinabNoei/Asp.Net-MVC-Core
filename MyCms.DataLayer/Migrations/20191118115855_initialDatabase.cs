        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageShortDesc = table.Column<string>(maxLength: 500, nullable: false),
                    PageText = table.Column<string>(nullable: false),
                    PageVisit = table.Column<int>(nullable: false),
                    PageImageName = table.Column<string>(nullable: true),
                    PageTags = table.Column<string>(nullable: true),
                    PageShowInSlider = table.Column<bool>(nullable: false),
                    RecordDate = table.Column<DateTime>(nullable: false),
                    MotificationDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
